...
def parse_args():
    ...
    parser.add_argument('--model_path',  type=str, default="checkpoints/acmmm2022_video_psnr.pth.tar")
    ...
    for ds_name in config:
        ...
        for seq_name in config[ds_name]['sequences']:
            ...
            for rate_idx in range(rate_num):
                cur_args = {}
                cur_args['log_path'] = os.path.join(args.log_path, "worker_{}.log".format(len(objs)))
